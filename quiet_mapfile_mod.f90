...
module quiet_mapfile_mod
  ...
  private assert, irange, getlun, itoa, pad
...
contains
  ...
  subroutine write_full_fits_map_1d_dp(map, ordering, filename)
    ...
    call write_minimal_header(header, 'map', append=.true., &
         ...
         polar = polarization )
    call add_card(header,"COMMENT","*************************************")
    call write_bintab((reshape(map(:), [size(map,1),1])), npix, nmaps, header, size(header), "!" // trim(filename))
  end subroutine
  subroutine write_full_fits_map_2d_dp(map, ordering, filename)
    ...
    call write_minimal_header(header, 'map', append=.true., &
         ...
         polar = polarization )
    call add_card(header,"COMMENT","*************************************")
    call write_bintab((reshape(map(:,:), [size(map,1),size(map,2)])), npix, nmaps, header, size(header), "!" // trim(filename))
  end subroutine
  subroutine write_full_fits_map_3d_dp(map, ordering, filename)
    ...
    call write_minimal_header(header, 'map', append=.true., &
         ...
         polar = polarization )
    call add_card(header,"COMMENT","*************************************")
    call write_bintab((reshape(map(:,:,1), [size(map,1),size(map,2)])), npix, nmaps, header, size(header), "!" // trim(filename))
  end subroutine
  ...
  subroutine write_full_fits_map_1d_int(map, ordering, filename)
    ...
    call write_minimal_header(header, 'map', append=.true., &
         ...
         polar = polarization )
    call add_card(header,"COMMENT","*************************************")
    call write_bintab(dble(reshape(map(:), [size(map,1),1])), npix, nmaps, header, size(header), "!" // trim(filename))
  end subroutine
  subroutine write_full_fits_map_2d_int(map, ordering, filename)
    ...
    call write_minimal_header(header, 'map', append=.true., &
         ...
         polar = polarization )
    call add_card(header,"COMMENT","*************************************")
    call write_bintab(dble(reshape(map(:,:), [size(map,1),size(map,2)])), npix, nmaps, header, size(header), "!" // trim(filename))
  end subroutine
  subroutine write_full_fits_map_3d_int(map, ordering, filename)
    ...
    call write_minimal_header(header, 'map', append=.true., &
         ...
         polar = polarization )
    call add_card(header,"COMMENT","*************************************")
    call write_bintab(dble(reshape(map(:,:,1), [size(map,1),size(map,2)])), npix, nmaps, header, size(header), "!" // trim(filename))
  end subroutine
